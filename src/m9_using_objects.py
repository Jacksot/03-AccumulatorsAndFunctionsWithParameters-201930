...
def two_circles():
    ...
    circle2 = rg.Circle(rg.Point(150, 200), 5)
...
def circle_and_rectangle():
    ...
    # -------------------------------------------------------------------------
    window = rg.RoseWindow()
    circle1 = rg.Circle(rg.Point(110, 100), 10)
    rectangle1 = rg.Rectangle(rg.Point(55, 50), rg.Point(50, 200))
...
def lines():
    ...
    window = rg.RoseWindow()
    line1 = rg.Line(rg.Point(100, 43), rg.Point(23, 45))
    line2 = rg.Line(rg.Point(64, 39), rg.Point(10, 4))
    line2.thickness = 5
